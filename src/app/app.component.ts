...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    if (AppConfig.production) {
      this.meta.addTags([
        { name: 'description', content: 'Employee Portal of ABC Corp Private Limited. ABC Corp Private Limited delivers GIS, Remote Sensing and Minining Services across India and overseas.' }
      ]);
    }
  }
}
